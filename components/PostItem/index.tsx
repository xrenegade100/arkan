...
const PostItem: React.FC<Props> = ({title, children, sidePosition}: Props) => {
    ...
    <div className={clsx("bg-slate-400 transition-all",
      {
        ...
        'w-4/5 lg:w-4/6 xl:w-3/5 rounded-r-full': !visibility && sidePosition === 'left',
        'w-4/5 lg:w-4/6 xl:w-3/5 rounded-l-full': !visibility && sidePosition === 'right',
      }
    )}>
      <div className={clsx("w-full flex items-center py-2 lg:py-3 xl:py-4",
      {
