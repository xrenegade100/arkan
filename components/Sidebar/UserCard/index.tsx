...
const UserCard: React.FC<Props> = ({ username, email, className }: Props) => (
  <div
    className={`${className} w-fit md:w-10/12 lg:w-11/12 bg-gradient-to-br from-secondary-main to-secondary-accent flex justify-center items-center py-4 px-2 shadow-md rounded-md`}
  >
    <Avatar
      dimen="sm"
      user={username}
